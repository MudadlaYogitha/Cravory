...
Develop a web application with the following pages, which must connect to the web API service:
  ...
  - **Location search**: Search restaurants in a given latitude and longitude range (e.g restaurants in 3 km of a given latitude and longitude).
  - **Image search**: Upload an image of a food like ice cream, pasta, etc., and search restaurants which offer those cuisines.
